...
HVM_VERSION_FROM_VERSION_FILE=$(cat "${HVM_VERSION}")
...
if [ -z "${INSTALL_WARN:-}" ]; then
    INSTALL_WARN=$(zenity --window-icon=${HVM_ICON_COLOR} --list --hide-header --title "HiddenVM" \
